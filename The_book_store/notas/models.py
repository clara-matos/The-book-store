...
class NotaDeLeitura(models.Model):
    ...
    usuario = models.ForeignKey(PerfilUsuario, on_delete=models.CASCADE, related_name='notas_de_leitura')
    ...
    def __str__(self):
        return f"Nota de {self.usuario.user.username} para '{self.livro.titulo}'"
